...
template <typename T> struct Intersect
{
	static bool RayAABB( Vec3<T> const& min_box, Vec3<T> const& max_box, Vec3<T> const& origin, Vec3<T> const& dir, Vec3<T>& coord )
    {
